...
class ValidCodeImg:
    def __init__(self, width=150, height=30, code_count=5, font_size=32, point_count=3, line_count=0,
                 img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        # 這裡要改
        filename=f'{os.getcwd()}/media/kumo.ttf'
        # 获取一个font字体对象参数是ttf的字体文件的目录，以及字体的大小
        font = ImageFont.truetype(filename, size=self.font_size)
